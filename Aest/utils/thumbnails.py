...
async def get_thumb(videoid,user_id):
    ...
    try:
        ...
        bg = Image.open(f"Aest/assets/riyu.png")
        ...
        font = ImageFont.truetype("Aest/assets/font.ttf", 45)
        ImageFont.truetype("Aest/assets/font2.ttf", 70)
        arial = ImageFont.truetype("Aest/assets/font.ttf", 30)
        ImageFont.truetype("Aest/assets/font.ttf", 30)
